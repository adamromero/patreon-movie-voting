...
const MovieList = ({ currentUser, isCreator }) => {
  ...
  useEffect(() => {
    ...
    if (filterOptions.status === status.Seen) {
      ...
      // } else if (filterOptions.status === status.RewatchFriend) {
      //   filteredList = filteredList.filter((movie) => movie.isRewatchFriend);
      ...
      <div className="flex bg-black w-full lg:w-[345px]">
        ...
        >
          <div className="flex gap-[5px] items-center">
            {filterOptions.alphabetical === alphabetical.Default && <FaSort />}
      ...
      {filteredMoviesList
        ...
        .map((data, index) => (
          <div
            ...
            style={{
              backgroundColor:
                data.hasReacted || data.hasSeen ? "rgb(0 0 0 / 40%)" : "#000",
              position: "relative",
            }}
          >
            <MovieListEntry
