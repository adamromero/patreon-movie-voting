...
const FilterMovieList = ({ currentUser }) => {
  ...
  return (
    <div className="flex flex-col justify-between mt-[10px] mb-[15px] sm:mt-0 xlg:flex-row w-full text-white gap-[20px]">
      <div>
          ...
          <div className="flex gap-[10px]">
            <div className="flex flex-col flex-1 lg:flex-none">
              ...
              >
                ...
                {/* <option value={status.RewatchFriend}>
                  Rewatch with Friend
                </option>*/}
          ...
          <div className="flex gap-[10px]">
            <div className="flex flex-col flex-1 lg:flex-none">
              ...
              >
                ...
                <option value={statusSort.Unwatched}>Unseen/Rewatch</option>
